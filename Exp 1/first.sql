...
select * from Doctors order by DoctorID asc limit 1; 
select * from Patients order by PatientID asc limit 1;
select * from Appointments order by AppointmentID asc limit 1;